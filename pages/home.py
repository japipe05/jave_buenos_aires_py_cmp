...
df_clientes = pd.read_parquet('/home/oecorrechag/m6_fix/data/df_clientes.parquet.gzip')
df_ba = gpd.read_file("/home/oecorrechag/m6_fix/data/df_ba.geojson")
...
def update_html_and_message(age_range, gender, barrio, aplicar):
    if aplicar:
        ...
        mapa_buenos_aires.save_to_html(data={'Comunas y barrios de Buenos Aires': filtered_data2}, config=config_mapa_buenos_aires, file_name='outputs/mapa_buenos_aires_preba.html')
